...
import type { ResponsePlan, RiskLevel } from "@/lib/types";
import { motion } from "framer-motion";
import { ShieldCheck, MapPin, Route, ListOrdered } from "lucide-react";
...
export function PlanPanel({ plan, verified = false }: PlanPanelProps) {
  return (
    <motion.div
